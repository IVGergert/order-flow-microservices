...
public class GlobalExceptionHandler{
    ...
    public ResponseEntity<ErrorResponseDto> handleCourierNotFound(CourierNotFoundException exception) {
    ...
    public ResponseEntity<ErrorResponseDto> handleAccessDenied(DeliveryAccessDeniedException exception) {
    ...
    public ResponseEntity<ErrorResponseDto> handleCourierNotAvailable(CourierNotAvailableException exception) {
    ...
    public ResponseEntity<ErrorResponseDto> handleInvalidDeliveryStatus(InvalidDeliveryStatusException exception) {
